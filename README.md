...
## Integrantes
- Mrlon Alvarez Ferragut (lider)
- Adriel Calzadilla Páez
- Lorena Pino Harada
- Maria Fernanda Pacheco González
- Liz Marien Lazo Gutierrez
- Kamila Díaz Ledesma
- Manuel Alejandro Hernández Caballerl

## Sobre el proyecto

Implementamos el juego de damas digital en C++11 usando la biblioteca SFML
para la interfaz grafica. El juego tiene dos modos: Un solo jugador (vs CPU) y
Dos jugadores. La CPU usa el algoritmo Minimax con profundidad 3 para
